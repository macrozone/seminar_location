...
Es ist daher nötig, die Daten Zwischenzuspeichern um sie später auszuwerten.
...
Wie in Abschnitt \ref{sec_concept} erwähnt, werden die Daten nicht in Echtzeit, sondern mit Verzögerung benötigt. Es ist also nötig, die Daten zwischenzuspeichern.
